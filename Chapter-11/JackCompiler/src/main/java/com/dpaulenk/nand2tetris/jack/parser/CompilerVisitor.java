...
public interface CompilerVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link CompilerParser#varExpr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitVarExpr(@NotNull CompilerParser.VarExprContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link CompilerParser#subroutineKind}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSubroutineKind(@NotNull CompilerParser.SubroutineKindContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link CompilerParser#number}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNumber(@NotNull CompilerParser.NumberContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitString(@NotNull CompilerParser.StringContext ctx);
	/**
